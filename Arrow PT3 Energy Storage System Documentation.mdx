...
|      | Left side flexible PCB                | FLEX_L                 |               |
|      | Right side flexible PCB               | FLEX_R                 |               |
|      | Battery power PCB                     | B_PWR_PCB              |               |
|      | Battery signal PCB                    | B_SIG_PCB              |               |
|      | Arduino MKR 1010                      |                        |               |
|      | ENNOID XLITE V4 BMS (Modified)        | XLITE_V4_M_PT3         |               |
|      |                                       |                        |               |
|      |                                       |                        |               |
|      |                                       |                        |               |
