...
- The cable used for wiring the multiple pin connectors is a Helukabel "SUPER-PAAR-TRONIC-340-C-PUR grey 6 x 2 x 0.5 mm²" (49853)

![](https://holocron.so/uploads/65e7b81b-helukabel-m49536-en-gb.png)
...
![](https://holocron.so/uploads/6e66cccd-powerwize.jpg.jpeg)

## System Reliability

The system reliablility is depending on several factors. The main advantage of the desigend system is the overall redundancy because of the six independet batteries.

Each battery is limited by its cell cycle life. MOLICEL states 500+ cylces for its P45B battery cell until it reaches around 80% retention. This can vary depending on how the cell is charged and discharged over time.

More real world tests have to be conducted to assess the system reliability. Other importand factors are:

- The temperature ratings of components
- The enviromental conditions under which we use the batteries

We had our first small aircraft crash with the batteries already installed. They all suffered no visual or technical damage during that incident. A statement on durability cannot yet be made at this time (15.07.2024).
