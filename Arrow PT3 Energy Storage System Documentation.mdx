...
- Internal power supply in each battery for 12V and 5V with isolated DCDC converters. Powering the arduino, the contactor and SSRs. Also used to give enable sigal to the Xlite BMS.
