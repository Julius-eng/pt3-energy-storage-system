...
|      | 5P1S positive copper cell terminal    | 02_COPPER_POS_5P1S     | 1             |
|      | 5P1S positive steel cell terminal     | 02_STEEL_POS_5P1S      | 1             |
|      | 5P1S negative copper cell terminal    | 02_COPPER_NEG_5P1S     | 1             |
|      | 5P1S negative steel cell terminal     | 02_STEEL_NEG_5P1S      | 1             |
|      | 5P2S_M mid pack copper cell connector | 02_COPPER_MID_5P2S_M   | 1             |
|      | 5P2S_M mid pack steel cell connector  | 02_STEEL_MID_5P2S_M    | 1             |
|      | M4 scew insert for 3D print           | M4_56_81               |               |
|      | M2 scew insert for 3D print           | M2_32_40               |               |
|      | Left side flexible PCB                | FLEX_L                 | 1             |
|      | Right side flexible PCB               | FLEX_R                 | 1             |
|      | Battery power PCB                     | B_PWR_PCB              | 1             |
|      | Battery signal PCB                    | B_SIG_PCB              | 1             |
|      | Arduino MKR 1010                      | MKR_1010               | 1             |
|      | ENNOID XLITE V4 BMS (Modified)        | XLITE_V4_M_PT3         | 1             |
|      | Contactor                             | EVD_150                | 1             |
|      | Mica Insulation Sheet                 | 02_MICA                | 2             |
|      | Top housing cfk sheet                 | CFK_TOP                | 1             |
|      | Bottom housing cfk sheet              | CFK_BTM                | 1             |
|      | Left housing aluminum side            | ALU_LEFT               | 1             |
|      | Right housing aluminum side           | ALU_RIGHT              | 1             |
|      | Front housing cover 3D print          | PRINT_FRONT_COVER      | 1             |
|      | Back housing cover 3D print           | PRINT_BACK_COVER       | 1             |
|      | M4 Screw                              |                        |               |
