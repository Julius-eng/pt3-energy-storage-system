...
- Internal power supply in each battery for 12V and 5V with isolated DCDC converters. Powering the arduino, the contactor and SSRs. The power supply is also used to give the enable sigal to the Xlite BMS.
